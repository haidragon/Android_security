#COMPILER_C=gcc
#COMPILER_CPP=g++
COMPILER_C=/usr/local/bin/afl-clang
COMPILER_CPP=/usr/local/bin/afl-clang++
...
export CFLAGS="-Wall -g" && export CC=$COMPILER_C && export CXX=$COMPILER_CPP && ./configure --prefix="/home/miy1z1ki/ffmpeg_build" --pkg-config-flags="--static" --extra-cflags="-I/home/miy1z1ki/ffmpeg_build/include -c -fsanitize=address -O0 -g -v" --extra-cxxflags="-I/home/miy1z1ki/ffmpeg_build/include -c -fsanitize=address -O0 -g -v" --extra-ldflags="-L/home/miy1z1ki/ffmpeg_build/lib -fsanitize=address" --extra-libs="-lpthread -lm" --bindir="/home/miy1z1ki/bin" --enable-gpl --enable-libass --enable-libfdk-aac --enable-libfreetype --enable-libmp3lame --enable-libvorbis --enable-libvpx --enable-nonfree --cc=$COMPILER_C --cxx=$COMPILER_CPP && make clean && make 
cd ..
